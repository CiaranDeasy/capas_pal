...
\footnotetext[1]{\texttt{ProTerm}s are actually called \texttt{Term}s in the source code. However, to avoid confusion between \texttt{term}, which encompasses all four term types, and \texttt{Term}, which refers specifically to instantiated non-numeric terms, I will refer to the latter as \texttt{ProTerm} throughout this document.}
